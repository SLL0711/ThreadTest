...
namespace ThreadLearning.Th.AsyncIO
{
    public class AsyncIO1
    {
        ...
        static async Task ProcessAsyncIO()
        {
            ...
            WriteLine($"Sum in all files:{sums.LongLength}");
            ...
            {
                string fileName = $"test{i + 1}.txt";
                deleteTasks[i] = SimulateAsyncDelete(fileName);
            }
        ...
        static Task SimulateAsyncDelete(string fileName)
        {
